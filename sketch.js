...
var ground, invisiGround, groundImg,backgroundimg,bd;
...
function preload(){
  ...
  backgroundimg= loadImage("silhouette-forest-background_8589-304.jpg") 
}
...
function setup(){
 createCanvas(600,300);
  ...
  bananaGroup = createGroup();
    ...
    bd= createSprite(300,240,600,200);
    bd.addAnimation("bg",backgroundimg);
...
function draw(){
  ...
  if (gameState === END){
    ...
    stroke("black")
    textSize(30);
    text("GAMEOVER!!!", 220, 160);
    fill("black");
    textSize(15);
    text("Press 'R' to play again", 240, 200);
    
    text("By:VRAJPATEL",240,240)
